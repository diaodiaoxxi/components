...
const selectorProps = {
  ...
  /* 定义 tabindx */
  tabindex: PropTypes.sNumber,
  /*  大数据场景下，是否开启虚拟滚动 */
  virtual: PropTypes.bool,
  /* 是否开启下拉框展开收起动画效果 */
  animated: PropTypes.oneOfType([Boolean, String]),
  /** * 是否开启赋值文本，选中下拉项 * 注意：开启下拉项，filterable=true, 粘贴不会产生过滤 */
  selectPaste: PropTypes.bool,
}
...
export default {
  ...
  */
  ...
  // 过滤方法 {'all','value','label',Function()}
  filterMethod: PropTypes.oneOfType([Function, String]).def('all'),
  /* 自定义下拉列表为空时的文本 */

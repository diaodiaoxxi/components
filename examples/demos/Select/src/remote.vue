<template>
  <div>
    ...
    <div>
      <h3>远程搜索示例</h3>
      <u-select v-model="model" :remote="remote" filterable clearable>
        <u-option
          v-for="option in options"
          :value="option.value"
          :key="option.value"
    ...
    <div>
      <h3>远程搜索示例,初始化赋值</h3>
      <u-select v-model="model2" :remote="remote" filterable clearable>
    ...
    <div>
      ...
      <u-select v-model="model3" :remote="remote3" filterable clearable>
        <u-option

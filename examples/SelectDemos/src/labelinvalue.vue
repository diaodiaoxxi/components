<template>
  <div>
    ...
    <h3>非标准对象配置 valueKey,labelInValue</h3>
    <div>
      <u-select-2
        v-model="mode230"
        style="width:260px"
        placeholder="配置label-in-value,valueKey"
        multiple
        labelInValue
        valueKey="code"
        labelKey="city"

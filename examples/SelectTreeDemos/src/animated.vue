<template>
  <div class="tree-demo" style="width: 500px;">
    ...
    <h-button @click="animated = !animated">animated: {{animated}}</h-button>
    ...
    <p>filterable</p>
    <u-select v-model="value2" ref="selecttree0" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll @on-expand="expand" @on-inside-select="select" :treeData="treeData"></u-select-tree>
    </u-select>

    <p>多选</p>
    <u-select v-model="value3" multiple ref="selecttree0" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll @on-expand="expand" @on-inside-select="select" :treeData="treeData"></u-select-tree>
    </u-select>

    <p>filterable</p>
    <u-select v-model="value4" multiple ref="selecttree0" filterable labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll @on-expand="expand" @on-inside-select="select" :treeData="treeData"></u-select-tree>
    </u-select>

    <p>multHeadType="text" && filterable</p>
    <u-select v-model="value5" multiple multHeadType="text" filterable  labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="treeData"></u-select-tree>
    </u-select>

    <p>multHeadType="text"</p>
    <u-select v-model="value5" multiple multHeadType="text" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="treeData"></u-select-tree>
    </u-select>

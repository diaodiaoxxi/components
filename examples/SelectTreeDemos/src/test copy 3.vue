<template>
  <div class="tree-demo">
    <h-button @click="setValueNull">setValue null</h-button>
    <p>单选</p>
    ...
    <h-button @click="setValue1(5)">setValue-5</h-button>
    ...
    <h-button @click="isArrow = !isArrow">isArrow: {{isArrow}}</h-button>

    <p>单选</p>

    <p>filterable</p>
    <u-select v-model="value2" ref="selecttree0" :clearable="clearable" :isArrow="isArrow" filterable  @on-paste="paste" @on-blur="blur" @on-focus="focus" @on-change="change" @on-click="click" :disabled="disabled" :readonly="readonly" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll @on-expand="expand" @on-inside-select="select" :treeData="treeData"></u-select-tree>
    </u-select>

    <p>多选</p>
    <u-select v-model="value3" multiple ref="selecttree0" :clearable="clearable" :isArrow="isArrow"  @on-paste="paste" @on-blur="blur" @on-focus="focus" @on-change="change" @on-click="click" :disabled="disabled" :readonly="readonly" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll @on-expand="expand" @on-inside-select="select" :treeData="treeData"></u-select-tree>
    </u-select>

    <p>filterable</p>
    <u-select v-model="value4" multiple ref="selecttree0" :clearable="clearable" :isArrow="isArrow" filterable  @on-paste="paste" @on-blur="blur" @on-focus="focus" @on-change="change" @on-click="click" :disabled="disabled" :readonly="readonly" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll @on-expand="expand" @on-inside-select="select" :treeData="treeData"></u-select-tree>
    </u-select>

    <p>multHeadType="text" && filterable</p>
    <u-select v-model="value5" multiple multHeadType="text" :clearable="clearable" :isArrow="isArrow" filterable @on-paste="paste" @on-blur="blur" @on-focus="focus" @on-change="change" @on-click="click" :disabled="disabled" :readonly="readonly" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="treeData"></u-select-tree>
    </u-select>

    <p>multHeadType="text"</p>
    <u-select v-model="value5" multiple multHeadType="text" :clearable="clearable" :isArrow="isArrow" @on-paste="paste" @on-blur="blur" @on-focus="focus" @on-change="change" @on-click="click" :disabled="disabled" :readonly="readonly" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="treeData"></u-select-tree>
    </u-select>

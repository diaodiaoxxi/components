<template>
  <div class="tree-demo" style="width: 500px; margin-bottom: 500px;">
    <p>placeholder</p>
    <u-select v-model="value1" placeholder="单选-null啊啊啊啊" labelKey="title" valueKey="id">
      <u-select-tree defaultExpandAll :treeData="treeData"></u-select-tree>
    </u-select>
    <u-select v-model="value1" filterable placeholder="单选-null啊啊啊啊" labelKey="title" valueKey="id">
      <u-select-tree defaultExpandAll :treeData="treeData"></u-select-tree>
    </u-select>
    <u-select v-model="value2" multiple placeholder="多选-null啊啊啊啊" labelKey="title" valueKey="id">
      <u-select-tree defaultExpandAll :treeData="treeData"></u-select-tree>
    </u-select>
    <u-select v-model="value2" multiple filterable placeholder="多选-null啊啊啊啊" labelKey="title" valueKey="id">
      <u-select-tree defaultExpandAll :treeData="treeData"></u-select-tree>
    </u-select>

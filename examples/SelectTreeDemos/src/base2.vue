<template>
  <div class="tree-demo" style="width: 500px">
    ...
    <h-radio-group v-model="type" type="button">
      <h-radio label="fade"></h-radio>
      <h-radio label="transition-drop"></h-radio>
    </h-radio-group>
    ...
    >
      <u-select-tree
        defaultExpandAll
        @on-expand="expand"
        @on-inside-select="select"
        :treeData="treeData"
      ></u-select-tree>
    </u-select>

    <p>animated 类型= 【{{ type }}】</p>
    <u-select v-model="value2" ref="selecttree0" :animated="type" labelKey="title" valueKey="id">
      <u-select-tree
        defaultExpandAll
        @on-expand="expand"
        @on-inside-select="select"
    ...
    <p>slide-fade</p>
    <u-select v-model="value2" ref="selecttree0" animated="bounce" labelKey="title" valueKey="id">
      <u-select-tree
        defaultExpandAll
        @on-expand="expand"
        @on-inside-select="select"

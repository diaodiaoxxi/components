<template>
  <div class="tree-demo" style="width: 500px;">
    ...
    <u-select v-model="value" notFoundText="not-found-text" ref="selecttree1" filterable :disabled="disabled" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="[]"></u-select-tree>
    </u-select>

     <p>notFoundText && 过滤搜索</p>
    <u-select v-model="value" notFoundText="not-found-text" ref="selecttree1" filterable :disabled="disabled" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="treeData"></u-select-tree>
    </u-select>

    <p>notFoundText && treeData=[] </p>
    <u-select v-model="value2" multiple notFoundText="not-found-text" ref="selecttree1" filterable :disabled="disabled" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="[]"></u-select-tree>
    </u-select>

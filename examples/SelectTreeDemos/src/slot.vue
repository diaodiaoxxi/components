<template>
  <div class="tree-demo" style="width: 500px;">
    ...
    <p>loading : {{loading}}</p>
    <u-select v-model="value" filterable :loading="loading" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="treeData"></u-select-tree>
    </u-select>

    <p>loading : {{loading}} && slot="loading"</p>
    <u-select v-model="value" filterable :loading="loading" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="treeData"></u-select-tree>
    ...
    <p>常规过滤</p>
    <u-select v-model="value" filterable labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="treeData"></u-select-tree>
    </u-select>
    ...
    <u-select v-model="value" filterable labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="treeData"></u-select-tree>
      <div slot="emptyList">not - found</div>
    </u-select>

    <p>slot="emptyList" && treeData=[]</p>
    <u-select v-model="value" filterable :loading="loading" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="[]"></u-select-tree>
      <div slot="emptyList">not - found</div>
    </u-select>
    <p>notFoundText && treeData=[]</p>
    <u-select v-model="value" filterable notFoundText="notFoundText" labelKey="title" valueKey="id">
      <u-select-tree  defaultExpandAll  :treeData="[]"></u-select-tree>
    </u-select>
